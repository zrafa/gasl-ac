...
tres bits para representar las posibles combinaciónes de esos tres permisos 
...
(sigiendo con un texto, por ejemplo a través del editor vi). Si {\tt x} se encuentra
...
directorio (ni aún root puede hacerlo). Intentemoslo: 
...
llamadas al sistema que crean y borran archivos, y sólo a trvés de 
...
Los permisos para borrar archivos son ondependientes del archivo mismo. 
