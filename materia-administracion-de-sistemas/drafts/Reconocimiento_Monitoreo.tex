...
\textbf{El kernel Linux me habla}
...
cuando necesita utilizar el hardware con algun fin. 
...
revisión por parte de los administradores de sistemas. Es tarea del administrador leer la 
información que el Kernel provee. 
...
identificación del problema observar si el dispositivo es reconocido o no. 
