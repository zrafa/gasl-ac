...
\item Utiliznado el comando \texttt{telinit} cambie el nivel de ejecución al de usuario 
individual. 
	\begin{itemize}
	...
	\item ¿Qué pasos deben llevarse a cabo para volver al estado de multiusuario?
	\end{itemize}
...
``I'll be back'' en todas las terminales del sistema. ¿Qué comando ejecutó? ¿Qué sucedió?
\item Reinicie la computadora en la que se encuentra trabajando \textbf{localmente} durante el 
reinicio observe con atención todos los mensajes y trate de identificar:
\begin{itemize}
\item A qué software involucrado en el proceso de arranque pertenece cada una de las salidas que ve. 
\item Gestores de arranque.
\item En qué momento comienza la carga del kernel Linux. 
\item Momento en el que el proceso init comienza a ejecutar.
\item Observe algunos de los servicios iniciados por init. 
\end{itemize}
\end{enumerate}

\section*{Ejercicio 3}
Sobre el directorio \texttt{/bin}
